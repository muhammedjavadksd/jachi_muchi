...
const CheckoutPage = lazy(() => import("@/features/checkout/pages/CheckoutPage/CheckoutPage").then(m => ({ default: m.CheckoutPage })));
...
export const ROUTES: RouteConfig[] = [
  ...
  // { path: "/account/3d-model", component: My3DModelPage, protected: true }, // [HIDDEN] My 3D Model — uncomment to restore
