    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1">
        <Container className="max-w-6xl">
          {/* Breadcrumb */}
          <nav className="py-4 text-sm text-gray-500 border-b border-gray-100" aria-label="Breadcrumb">
          ...
          {/* Hero section */}
          <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center py-12 sm:py-16">
            <div className="order-2 lg:order-1">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 mt-6 text-teal-600 font-semibold hover:text-teal-700 transition-colors"
              >
                Read more
                <span aria-hidden>→</span>
              </Link>
            </div>
            <div className="order-1 lg:order-2 aspect-[4/3] rounded-xl overflow-hidden bg-gray-100">
              <img
          ...
          {SERVICE_SECTIONS.map((section) => (
            <section
              key={section.id}
              id={section.id}
              className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center py-12 sm:py-16 border-t border-gray-100"
            >
              {section.imageFirst ? (
                <>
                  ...
                  <div>
                    ...
                    {section.highlight && (
                      <p className="mt-2 text-red-600 font-semibold text-sm uppercase tracking-wide">
                        {section.highlight}
                      </p>
                    )}
                    ...
                    <Link
                      to={section.link}
                      className="inline-flex items-center gap-2 mt-5 text-teal-600 font-semibold hover:text-teal-700 transition-colors"
                    >
                      Read more
                      <span aria-hidden>→</span>
                    </Link>
