              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 mb-4 md:mb-6 lg:mb-8">
                ...
                <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                  ...
                  <button
                    ...
                    className={`relative w-11 h-5 sm:w-12 sm:h-6 rounded-full transition-colors ${
                  ...
                  >
                    <span
                      className={`absolute top-0.5 sm:top-1 w-4 h-4 bg-white rounded-full transition-transform ${
                        whatsappUpdates ? "translate-x-6 sm:translate-x-7" : "translate-x-1"
                      }`}
                    />
                  </button>
                </div>
                        ...
                        <div className="flex items-center gap-2 sm:gap-3">
                          {order.items.slice(0, 3).map((item, idx) => (
                            <div key={idx} className="w-12 h-12 sm:w-14 sm:h-14 bg-white rounded-lg overflow-hidden border border-gray-200 shrink-0">
                              <img src={item.image} alt={item.name} className="w-full h-full object-contain p-0.5 sm:p-1" />
                            </div>
                          ))}
                          {order.items.length > 3 && (
                            <div className="w-12 h-12 sm:w-14 sm:h-14 bg-white rounded-lg flex items-center justify-center border border-gray-200 shrink-0">
                              <span className="text-xs sm:text-sm font-medium text-gray-500">+{order.items.length - 3}</span>
                            </div>
                          )}
