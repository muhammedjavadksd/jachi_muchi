    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1">
        <Container className="max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          {/* OUR STORY */}
          <section className="py-10 sm:py-14 lg:py-16 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-start">
            <div className="lg:col-span-5">
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 tracking-tight">
                OUR STORY
              </h2>
              <div className="mt-6 sm:mt-8 flex justify-center lg:justify-start">
                <div className="h-40 w-40 sm:h-52 sm:w-52 lg:h-56 lg:w-56 rounded-2xl bg-gray-100 flex items-center justify-center text-gray-400" aria-hidden>
                  <svg className="w-16 h-16 sm:w-20 sm:h-20" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1">
          ...
          {/* GREAT QUALITY */}
          <section className="py-10 sm:py-14 lg:py-16 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center border-t border-gray-100">
            <div className="lg:col-span-6 order-2 lg:order-1 space-y-5 sm:space-y-6">
              ...
              <div className="space-y-5 sm:space-y-6">
                <div>
                  <h3 className="text-sm sm:text-base font-semibold text-gray-900 mb-2">Precision by design</h3>
                ...
                <div>
                  <h3 className="text-sm sm:text-base font-semibold text-gray-900 mb-2">People behind the process</h3>
                  <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
            ...
            <div className="lg:col-span-6 order-1 lg:order-2 flex justify-center lg:justify-end">
              <div className="h-48 w-48 sm:h-56 sm:w-56 lg:h-64 lg:w-64 rounded-2xl bg-teal-50 flex items-center justify-center text-teal-200" aria-hidden>
                <svg className="w-20 h-20 sm:w-24 sm:h-24" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1">
          ...
          <section className="py-10 sm:py-14 lg:py-16 border-t border-gray-100">
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 tracking-tight mb-8 sm:mb-10">
              VARIETY
            </h2>
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14">
              <div className="lg:col-span-7 space-y-5 sm:space-y-6">
                <div>
                  <h3 className="text-sm sm:text-base font-semibold text-gray-900 mb-2">Something for everyone</h3>
                  <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                ...
                <div>
                  <h3 className="text-sm sm:text-base font-semibold text-gray-900 mb-2">Designed with care</h3>
                  <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                    From classic shapes to modern trends, we pay attention to detail so every frame is both functional and stylish.
                  </p>
                </div>
                <div>
                  <h3 className="text-sm sm:text-base font-semibold text-gray-900 mb-2">Always evolving</h3>
                  <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                    We refresh our styles regularly so you can keep up with the latest looks without compromising on quality or value.
                  </p>
                </div>
              </div>
              <div className="lg:col-span-5 flex flex-wrap gap-3 sm:gap-4 justify-center lg:justify-end">
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="h-28 w-28 sm:h-32 sm:w-32 lg:h-36 lg:w-36 rounded-xl bg-gray-100 flex items-center justify-center text-gray-400"
                    aria-hidden
                  >
                    <svg className="w-10 h-10 sm:w-12 sm:h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1">
          ...
          <section className="py-10 sm:py-14 lg:py-16 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center border-t border-gray-100">
            ...
            <div className="lg:col-span-6 order-1 lg:order-2 flex justify-center lg:justify-end">
              <div className="h-40 w-56 sm:h-48 sm:w-64 lg:h-56 lg:w-72 rounded-2xl bg-amber-50 flex items-center justify-center text-amber-200" aria-hidden>
                <span className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tighter text-amber-300/80">VALUE</span>
              </div>
            </div>
          </section>
          ...
          {/* CONTACT US */}
          <section className="py-10 sm:py-14 lg:py-16 border-t border-gray-100">
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 tracking-tight mb-6 sm:mb-8">
              CONTACT US
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 text-sm">
              <div>
            ...
            <div className="mt-6 sm:mt-8">
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 rounded-lg bg-teal-600 px-4 sm:px-5 py-2 sm:py-2.5 text-sm font-medium text-white hover:bg-teal-700 transition-colors"
              >
          ...
          {/* TRUST */}
          <section className="py-10 sm:py-14 lg:py-16 border-t border-gray-200 bg-gray-50 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 tracking-tight text-center mb-8 sm:mb-10">
                TRUST
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-8 lg:gap-10">
                <div className="bg-white rounded-2xl border border-gray-100 p-5 sm:p-6 lg:p-8 shadow-sm">
                  <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">14-day easy returns</h3>
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-5 sm:p-6 lg:p-8 shadow-sm">
                  <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">1-year warranty</h3>
                  <p className="text-sm text-gray-600 leading-relaxed">
