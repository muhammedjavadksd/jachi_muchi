...
export const SEARCH_FILTERS: FilterGroup[] = [
  ...
  },
  {
    ...
    collapsible: false,
    options: [
      { id: "black", label: "Black", count: 377 },
      { id: "transparent", label: "Transparent", count: 200 },
      { id: "blue", label: "Blue", count: 159 },
      { id: "gunmetal", label: "Gunmetal", count: 97 },
      { id: "gold", label: "Gold", count: 96 },
      { id: "grey", label: "Grey", count: 91 },
      { id: "silver", label: "Silver", count: 85 },
      { id: "brown", label: "Brown", count: 47 },
      { id: "green", label: "Green", count: 36 },
      { id: "purple", label: "Purple", count: 34 },
      { id: "pink", label: "Pink", count: 29 },
      { id: "rose-gold", label: "Rose Gold", count: 20 },
    ],
  },
  {
    id: "brands",
    ...
    type: "checkbox",
    options: [
      { id: "vincent-chase", label: "Vincent Chase", count: 623 },
      { id: "lenskart-air", label: "Lenskart Air", count: 495 },
      { id: "john-jacobs", label: "John Jacobs", count: 222 },
      { id: "lenskart-studio", label: "Lenskart STUDIO", count: 76 },
      { id: "lenskart-hustlr", label: "Lenskart Hustlr", count: 68 },
      { id: "fossil", label: "Fossil", count: 57 },
      { id: "owndays", label: "OWNDAYS", count: 52 },
      { id: "lenskart", label: "Lenskart", count: 13 },
    ],
  },
  {
    id: "frame-size",
    ...
    type: "checkbox",
    options: [
      { id: "extra-narrow", label: "Extra Narrow", count: 45 },
      { id: "narrow", label: "Narrow", count: 156 },
      { id: "medium", label: "Medium", count: 423 },
      { id: "wide", label: "Wide", count: 287 },
      { id: "extra-wide", label: "Extra Wide", count: 89 },
    ],
  },
  {
    id: "price",
    ...
    type: "checkbox",
    options: [
      { id: "under-1000", label: "Under ₹1,000", count: 123 },
      { id: "1000-2000", label: "₹1,000 - ₹2,000", count: 345 },
      { id: "2000-3000", label: "₹2,000 - ₹3,000", count: 234 },
      { id: "3000-5000", label: "₹3,000 - ₹5,000", count: 156 },
      { id: "above-5000", label: "Above ₹5,000", count: 78 },
    ],
  },
  {
    id: "gender",
    ...
    options: [
      ...
      { id: "unisex", label: "Unisex", count: 234 },
      { id: "kids", label: "Kids", count: 67 },
    ],
  },
  {
    id: "material",
    ...
    type: "checkbox",
    options: [
      { id: "metal", label: "Metal", count: 345 },
      { id: "acetate", label: "Acetate", count: 278 },
      { id: "titanium", label: "Titanium", count: 156 },
      { id: "tr90", label: "TR90", count: 189 },
      { id: "plastic", label: "Plastic", count: 123 },
    ],
  },
  {
    id: "weight-group",
    ...
    type: "checkbox",
    options: [
      { id: "light", label: "Light (0-15g)", count: 234 },
      { id: "average", label: "Average (15-25g)", count: 345 },
      { id: "heavy", label: "Heavy (25g+)", count: 89 },
    ],
  },
  {
    ...
    type: "checkbox",
    options: [
      { id: "single-vision", label: "Single Vision", count: 567 },
      { id: "bifocal", label: "Bifocal", count: 234 },
      { id: "progressive", label: "Progressive", count: 189 },
      { id: "zero-power", label: "Zero Power", count: 345 },
    ],
  },
];
